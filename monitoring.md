...
To get an idea of how long it usually takes `amppackager` to handle a request, look at the respective 0.5 percentile. To check the rare, worst case scenario, look at 0.9 and 0.99 percentile.
