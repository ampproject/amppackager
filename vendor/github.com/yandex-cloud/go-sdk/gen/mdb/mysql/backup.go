...
// Delete implements mysql.BackupServiceClient
func (c *BackupServiceClient) Delete(ctx context.Context, in *mysql.DeleteBackupRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	conn, err := c.getConn(ctx)
	if err != nil {
		return nil, err
	}
	return mysql.NewBackupServiceClient(conn).Delete(ctx, in, opts...)
}
