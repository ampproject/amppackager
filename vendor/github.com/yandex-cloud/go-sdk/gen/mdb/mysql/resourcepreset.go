...
func (c *ResourcePresetServiceClient) ResourcePresetIterator(ctx context.Context, req *mysql.ListResourcePresetsRequest, opts ...grpc.CallOption) *ResourcePresetIterator {
	var pageSize int64
...
func (it *ResourcePresetIterator) Take(size int64) ([]*mysql.ResourcePreset, error) {
	if it.err != nil {
		return nil, it.err
	}
	...
	var result []*mysql.ResourcePreset
...
func (it *ResourcePresetIterator) TakeAll() ([]*mysql.ResourcePreset, error) {
	return it.Take(0)
}
