...
type ResourcePresetIterator struct {
	...
	request *mongodb.ListResourcePresetsRequest

	items []*mongodb.ResourcePreset
}

func (c *ResourcePresetServiceClient) ResourcePresetIterator(ctx context.Context, req *mongodb.ListResourcePresetsRequest, opts ...grpc.CallOption) *ResourcePresetIterator {
	var pageSize int64
...
func (it *ResourcePresetIterator) Take(size int64) ([]*mongodb.ResourcePreset, error) {
	if it.err != nil {
		return nil, it.err
	}
	...
	var result []*mongodb.ResourcePreset
...
func (it *ResourcePresetIterator) Value() *mongodb.ResourcePreset {
	if len(it.items) == 0 {
