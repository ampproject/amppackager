...
func (c *ResourcePresetServiceClient) ResourcePresetIterator(ctx context.Context, req *dataproc.ListResourcePresetsRequest, opts ...grpc.CallOption) *ResourcePresetIterator {
	var pageSize int64
...
func (it *ResourcePresetIterator) Take(size int64) ([]*dataproc.ResourcePreset, error) {
	if it.err != nil {
		return nil, it.err
	}
	...
	var result []*dataproc.ResourcePreset
...
func (it *ResourcePresetIterator) TakeAll() ([]*dataproc.ResourcePreset, error) {
	return it.Take(0)
}
