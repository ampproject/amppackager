...
var file_yandex_cloud_datasphere_v2_docker_image_service_proto_goTypes = []interface{}{
...
func file_yandex_cloud_datasphere_v2_docker_image_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_datasphere_v2_docker_image_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
