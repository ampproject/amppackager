...
func (m *PostgresqlHostConfig15_1C) SetWorkMem(v *wrapperspb.Int64Value) {
	m.WorkMem = v
}
...
func (m *PostgresqlHostConfig15_1C) SetConstraintExclusion(v PostgresqlHostConfig15_1C_ConstraintExclusion) {
...
func (m *PostgresqlHostConfig15_1C) SetForceParallelMode(v PostgresqlHostConfig15_1C_ForceParallelMode) {
	m.ForceParallelMode = v
}

func (m *PostgresqlHostConfig15_1C) SetClientMinMessages(v PostgresqlHostConfig15_1C_LogLevel) {
	m.ClientMinMessages = v
}

func (m *PostgresqlHostConfig15_1C) SetLogMinMessages(v PostgresqlHostConfig15_1C_LogLevel) {
	m.LogMinMessages = v
}
...
func (m *PostgresqlHostConfig15_1C) SetLogErrorVerbosity(v PostgresqlHostConfig15_1C_LogErrorVerbosity) {
...
func (m *PostgresqlHostConfig15_1C) SetLogStatement(v PostgresqlHostConfig15_1C_LogStatement) {
	m.LogStatement = v
}
...
func (m *PostgresqlHostConfig15_1C) SetDefaultTransactionIsolation(v PostgresqlHostConfig15_1C_TransactionIsolation) {
...
func (m *PostgresqlHostConfig15_1C) SetByteaOutput(v PostgresqlHostConfig15_1C_ByteaOutput) {
	m.ByteaOutput = v
}

func (m *PostgresqlHostConfig15_1C) SetXmlbinary(v PostgresqlHostConfig15_1C_XmlBinary) {
	m.Xmlbinary = v
}

func (m *PostgresqlHostConfig15_1C) SetXmloption(v PostgresqlHostConfig15_1C_XmlOption) {
	m.Xmloption = v
}
...
func (m *PostgresqlHostConfig15_1C) SetBackslashQuote(v PostgresqlHostConfig15_1C_BackslashQuote) {
	m.BackslashQuote = v
}
