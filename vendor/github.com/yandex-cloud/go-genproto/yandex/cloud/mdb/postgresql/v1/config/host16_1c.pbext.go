...
func (m *PostgresqlHostConfig16_1C) SetWorkMem(v *wrapperspb.Int64Value) {
	m.WorkMem = v
}
...
func (m *PostgresqlHostConfig16_1C) SetConstraintExclusion(v PostgresqlHostConfig16_1C_ConstraintExclusion) {
...
func (m *PostgresqlHostConfig16_1C) SetDebugParallelQuery(v PostgresqlHostConfig16_1C_DebugParallelQuery) {
	m.DebugParallelQuery = v
}

func (m *PostgresqlHostConfig16_1C) SetClientMinMessages(v PostgresqlHostConfig16_1C_LogLevel) {
	m.ClientMinMessages = v
}

func (m *PostgresqlHostConfig16_1C) SetLogMinMessages(v PostgresqlHostConfig16_1C_LogLevel) {
	m.LogMinMessages = v
}
...
func (m *PostgresqlHostConfig16_1C) SetLogErrorVerbosity(v PostgresqlHostConfig16_1C_LogErrorVerbosity) {
...
func (m *PostgresqlHostConfig16_1C) SetLogStatement(v PostgresqlHostConfig16_1C_LogStatement) {
	m.LogStatement = v
}
...
func (m *PostgresqlHostConfig16_1C) SetDefaultTransactionIsolation(v PostgresqlHostConfig16_1C_TransactionIsolation) {
...
func (m *PostgresqlHostConfig16_1C) SetByteaOutput(v PostgresqlHostConfig16_1C_ByteaOutput) {
	m.ByteaOutput = v
}

func (m *PostgresqlHostConfig16_1C) SetXmlbinary(v PostgresqlHostConfig16_1C_XmlBinary) {
	m.Xmlbinary = v
}

func (m *PostgresqlHostConfig16_1C) SetXmloption(v PostgresqlHostConfig16_1C_XmlOption) {
	m.Xmloption = v
}
...
func (m *PostgresqlHostConfig16_1C) SetBackslashQuote(v PostgresqlHostConfig16_1C_BackslashQuote) {
	m.BackslashQuote = v
}
