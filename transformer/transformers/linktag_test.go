	...
	tcs := []tt.TestCase{
		{
			...
			Expected: tt.Concat(tt.Doctype, "<html ⚡=\"\"><head>",
				tt.MetaCharset, tt.MetaViewport, tt.ScriptAMPRuntime,
				tt.LinkFavicon, tt.LinkGoogleFontPreconnect,
				tt.LinkGoogleFontDisplayOptional, tt.LinkCanonical,
				tt.StyleAMPBoilerplate, tt.NoscriptAMPBoilerplate,
		...
		},
		{
			...
			Expected: tt.Concat(tt.Doctype, "<html ⚡=\"\"><head>",
				tt.MetaCharset, tt.MetaViewport, tt.ScriptAMPRuntime,
				tt.LinkFavicon, tt.LinkGoogleFontPreconnect,
				tt.LinkGoogleFontDisplayOptional, tt.LinkGoogleFontDisplayOptional,
				tt.LinkCanonical, tt.StyleAMPBoilerplate,
				tt.NoscriptAMPBoilerplate, LinkGoogleFontPreconnect,
				"</head><body></body></html>"),
		},
		{
			Desc: "Does not overwrite Google Font with Display Component",
			Input: tt.Concat(tt.Doctype, "<html ⚡><head>",
				tt.MetaCharset, tt.MetaViewport, tt.ScriptAMPRuntime,
				tt.LinkFavicon, tt.LinkGoogleFontDisplayBlock, tt.LinkCanonical,
				tt.StyleAMPBoilerplate, tt.NoscriptAMPBoilerplate,
				"</head><body></body></html>"),
			Expected: tt.Concat(tt.Doctype, "<html ⚡=\"\"><head>",
				tt.MetaCharset, tt.MetaViewport, tt.ScriptAMPRuntime,
				tt.LinkFavicon, tt.LinkGoogleFontPreconnect,
				tt.LinkGoogleFontDisplayBlock, tt.LinkCanonical,
				tt.StyleAMPBoilerplate, tt.NoscriptAMPBoilerplate,
				LinkGoogleFontPreconnect,
				"</head><body></body></html>"),
		},
		{
			Desc: "Does not add Display Component for Google Font Early Access",
			Input: tt.Concat(tt.Doctype, "<html ⚡><head>",
				tt.MetaCharset, tt.MetaViewport, tt.ScriptAMPRuntime,
				tt.LinkFavicon, tt.LinkGoogleFontEarlyAccess, tt.LinkCanonical,
				tt.StyleAMPBoilerplate, tt.NoscriptAMPBoilerplate,
				"</head><body></body></html>"),
			Expected: tt.Concat(tt.Doctype, "<html ⚡=\"\"><head>",
				tt.MetaCharset, tt.MetaViewport, tt.ScriptAMPRuntime,
				tt.LinkFavicon, tt.LinkGoogleFontPreconnect,
				tt.LinkGoogleFontEarlyAccess, tt.LinkCanonical,
				tt.StyleAMPBoilerplate, tt.NoscriptAMPBoilerplate,
				LinkGoogleFontPreconnect,
				"</head><body></body></html>"),
		},
		{
			Desc: "Does not add Display Component for Google Font Icon",
			Input: tt.Concat(tt.Doctype, "<html ⚡><head>",
				tt.MetaCharset, tt.MetaViewport, tt.ScriptAMPRuntime,
				tt.LinkFavicon, tt.LinkGoogleFontIcon, tt.LinkCanonical,
				tt.StyleAMPBoilerplate, tt.NoscriptAMPBoilerplate,
				"</head><body></body></html>"),
			Expected: tt.Concat(tt.Doctype, "<html ⚡=\"\"><head>",
				tt.MetaCharset, tt.MetaViewport, tt.ScriptAMPRuntime,
				tt.LinkFavicon, tt.LinkGoogleFontPreconnect,
				tt.LinkGoogleFontIcon, tt.LinkCanonical,
				tt.StyleAMPBoilerplate, tt.NoscriptAMPBoilerplate,
				LinkGoogleFontPreconnect,
				"</head><body></body></html>"),
		},
