		...
		if isAsyncScriptTag(c) {
			...
			if src, ok := htmlnode.FindAttribute(c, "", "src"); ok {
				if parsedURL, err := url.Parse(src.Val); err != nil {
					...
					if strings.HasSuffix(parsedURL.Path, "/lts/v0.js") {
						htmlnode.SetAttribute(c, "", "src", "https://cdn.ampproject.org/lts/v0.js")
					} else if strings.HasSuffix(parsedURL.Path, "/v0.js") {
						htmlnode.SetAttribute(c, "", "src", "https://cdn.ampproject.org/v0.js")
					} else if strings.HasSuffix(parsedURL.Path, "/lts/v0.mjs") {
						htmlnode.SetAttribute(c, "", "src", "https://cdn.ampproject.org/lts/v0.mjs")
					} else if strings.HasSuffix(parsedURL.Path, "/v0.mjs") {
						htmlnode.SetAttribute(c, "", "src", "https://cdn.ampproject.org/v0.mjs")
					} else if strings.HasSuffix(parsedURL.Path, "/lts/amp4ads-v0.js") {
						htmlnode.SetAttribute(c, "", "src", "https://cdn.ampproject.org/lts/amp4ads-v0.js")
					} else if strings.HasSuffix(parsedURL.Path, "/amp4ads-v0.js") {
						htmlnode.SetAttribute(c, "", "src", "https://cdn.ampproject.org/amp4ads-v0.js")
					} else if strings.HasSuffix(parsedURL.Path, "/lts/amp4ads-v0.mjs") {
						htmlnode.SetAttribute(c, "", "src", "https://cdn.ampproject.org/lts/amp4ads-v0.mjs")
						...
						if endPart, ok := ExtractScriptNameAndVersionPart(parsedURL.Path); ok {
							if strings.HasPrefix(parsedURL.Path, "/lts/v0/") {
							        htmlnode.SetAttribute(c, "", "src", "https://cdn.ampproject.org/lts/v0/"+endPart)
							} else {
...
func ExtractScriptNameAndVersionPart(urlPath string) (string, bool) {
	...
	if !(strings.HasPrefix(urlPath, "/v0/amp-") ||
	     strings.HasPrefix(urlPath,  "/lts/v0/amp-")) {
		return "", false
	}
	...
	if strings.HasPrefix(urlPath, "/v0/amp-") {
	  endPart = urlPath[len("/v0/"):]
        } else if strings.HasPrefix(urlPath, "/lts/v0/amp-") {
	  endPart = urlPath[len("/lts/v0/"):]
        }
