...
func TestAbsoluteURLTansformer(t *testing.T) {
	tcs := []struct {
		...
		},
		{
			...
			expected:    "<a href=mailto:devnull@example.com>mail</a>",
			baseURL:     fooURL,
			documentURL: fooURL,
		},
		{
		...
		{
			desc:        "Anchor tag target is unmodified",
			input:       "<a href=" + fooURL + "/ target=popup>anchor</a>",
			expected:    "<a href=" + fooURL + "/ target=popup>anchor</a>",
			baseURL:     fooURL,
			documentURL: fooURL,
		},
		{
		...
		},
		{
			...
			input:       "<a href='/'>foo</a>",
			expected:    "<a href=https://example.com/>foo</a>",
		...
		},
		{
			...
			expected:    "<a href=https://www.example.com/foo.com/baz.html>Foo</a>",
