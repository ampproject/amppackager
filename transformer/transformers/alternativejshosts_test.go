...
func TestAlternativeJsHosts(t *testing.T) {
	tcs := []tt.TestCase{
		...
		{
			Desc: "Do Nothing To Cdn Js LTS",
			Input: tt.Concat("<html><head>",
				"<script async src=https://cdn.ampproject.org/lts/v0.js></script>",
				"<script async src=https://cdn.ampproject.org/lts/amp4ads-v0.js></script>",
				"<script async src=https://cdn.ampproject.org/lts/v0/amp-ad-exit-0.1.js>",
				"</script>",
				"</head><body></body></html>"),
			Expected: tt.Concat("<html><head>",
				"<script async src=https://cdn.ampproject.org/lts/v0.js></script>",
		...
		{
			Desc: "Do Nothing To Cdn mjs LTS",
			Input: tt.Concat("<html><head>",
				"<script async src=https://cdn.ampproject.org/lts/v0.mjs></script>",
				"<script async src=https://cdn.ampproject.org/lts/amp4ads-v0.mjs></script>",
				"<script async src=https://cdn.ampproject.org/lts/v0/amp-ad-exit-0.1.mjs>",
				"</script>",
				"</head><body></body></html>"),
			Expected: tt.Concat("<html><head>",
				"<script async src=https://cdn.ampproject.org/lts/v0.mjs></script>",
		...
		{
			Desc: "Rewrites AmpJs To AmpProject LTS",
			Input: tt.Concat("<html><head>",
				"<script async src=https://ampjs.org/lts/v0.js></script>",
				"<script async src=https://ampjs.org/lts/amp4ads-v0.js></script>",
				"<script async src=https://ampjs.org/lts/v0/amp-ad-exit-0.1.js>",
				"</script>",
				"</head><body></body></html>"),
			Expected: tt.Concat("<html><head>",
				"<script async src=https://cdn.ampproject.org/lts/v0.js></script>",
		...
		{
			Desc: "Rewrites Self Host To AmpProject LTS",
			Input: tt.Concat("<html><head>",
				"<script async src=https://selfhost.com/lts/v0.js></script>",
				"<script async src=https://selfhost.com/lts/amp4ads-v0.js></script>",
				"<script async src=https://selfhost.com/lts/v0/amp-ad-exit-0.1.js>",
				"</script>",
				"</head><body></body></html>"),
			Expected: tt.Concat("<html><head>",
				"<script async src=https://cdn.ampproject.org/lts/v0.js></script>",
